...
def dw_out1():
    int_w=25;
    frac_w=6;
    with open('./out_file_v1/dw0_out.txt','r') as f:
        o0_contents=f.readlines()

    with open('./out_file_v1/dw1_out.txt','r') as f:
        o1_contents=f.readlines()
        
    with open('./out_file_v1/dw2_out.txt','r') as f:
        o2_contents=f.readlines()
        
    with open('./out_file_v1/dw3_out.txt','r') as f:
