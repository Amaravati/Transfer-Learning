...
def dw_up():
    int_w=4;
    frac_w=10;
    with open('./out_file_v1/dw0_up.txt','r') as f:
        o0_contents=f.readlines()

    with open('./out_file_v1/dw1_up.txt','r') as f:
        o1_contents=f.readlines()
        
    with open('./out_file_v1/dw2_up.txt','r') as f:
        o2_contents=f.readlines()
        
    with open('./out_file_v1/dw3_up.txt','r') as f:
