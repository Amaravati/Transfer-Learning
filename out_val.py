...
def out_val():
    int_w=13;
    frac_w=13;
    with open('./out_file_v1/output_o0.txt','r') as f:
        o0_contents=f.readlines()

    with open('./out_file_v1/output_o1.txt','r') as f:
        o1_contents=f.readlines()
        
    with open('./out_file_v1/output_o2.txt','r') as f:
        o2_contents=f.readlines()
        
    with open('./out_file_v1/output_o3.txt','r') as f:
