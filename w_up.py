...
def w_up():
    int_w=2;
    frac_w=12;
    with open('./out_file_v1/w0_up.txt','r') as f:
        o0_contents=f.readlines()

    with open('./out_file_v1/w1_up.txt','r') as f:
        o1_contents=f.readlines()
        
    with open('./out_file_v1/w2_up.txt','r') as f:
        o2_contents=f.readlines()
        
    with open('./out_file_v1/w3_up.txt','r') as f:
